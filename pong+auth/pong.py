from PyQt6.QtWidgets import QMainWindow, QWidget, QApplication, QLabel, QPushButton
...
class PongWindow(QMainWindow):
    def __init__(self):
        ...
        self.setChildrenFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.btn_start = QPushButton("start", lbl_field)
        self.btn_start.setStyleSheet('background-color: light grey')
        self.btn_start.setGeometry(380, 190, 40, 20)
    ...
    def setChildrenFocusPolicy(self, policy):
        def recursive_set_focus_policy(parent_widget):
            for child in parent_widget.findChildren(QWidget):
                child.setFocusPolicy(policy)
                recursive_set_focus_policy(child)
        recursive_set_focus_policy(self)
